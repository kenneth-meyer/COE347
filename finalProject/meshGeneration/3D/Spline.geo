...
dimScale = 0.001; // mm to mm

dl = 1500; // domain length
dw = 500; // domain width
dh = 200; // domain height

cl = 177.8; // car length
cw = 69.85; // car width
ch = cw*2/3; // car height
cbot = 9.525; // car bottom clearance
cxloc = cl*3; // x location of front of car relative to domain length
...
// Meshing:
Mesh.CharacteristicLengthFactor = 0.025; // .05 yields ~1M elements
Characteristic Length{PointsOf{Physical Surface{"car"};}} = 1;
Characteristic Length{PointsOf{Physical Surface{"inlet"};}} = 20;
Characteristic Length{PointsOf{Physical Surface{"bottom"};}} = 10;
//Characteristic Length{PointsOf{Physical Surface{"right"};}} = 20;
Characteristic Length{PointsOf{Physical Surface{"frontAndBack"};}} = 20;
Characteristic Length{PointsOf{Physical Surface{"top"};}} = 20;
//Characteristic Length{PointsOf{Physical Surface{"left"};}} = 20;
Characteristic Length{PointsOf{Physical Surface{"outlet"};}} = 20;
